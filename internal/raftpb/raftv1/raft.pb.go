...
type Entry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Cmd           CommandType            `protobuf:"varint,1,opt,name=cmd,proto3,enum=raft.v1.CommandType" json:"cmd,omitempty"`
...
func (x *Entry) GetCmd() CommandType {
	if x != nil {
		return x.Cmd
	}
...
func (x *AppendEntriesRequest) GetLeaderTerm() int32 {
	if x != nil {
		return x.LeaderTerm
	}
	return 0
...
const file_raft_v1_raft_proto_rawDesc = "" +
	...
	"\x04term\x18\x01 \x01(\x05R\x04term\x12!\n" +
	"\fvote_granted\x18\x02 \x01(\bR\vvoteGranted\"\x81\x01\n" +
	"\x05Entry\x12&\n" +
	"\x03cmd\x18\x01 \x01(\x0e2\x14.raft.v1.CommandTypeR\x03cmd\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\x12\x14\n" +
	"\x05index\x18\x04 \x01(\x05R\x05index\x12\x12\n" +
	"\x04term\x18\x05 \x01(\x05R\x04term\"\xed\x01\n" +
	...
	"\x03SET\x10\x00\x12\n" +
	"\n" +
	"\x06DELETE\x10\x012\xa7\x01\n" +
	"\vRaftService\x12H\n" +
	"\vRequestVote\x12\x1b.raft.v1.RequestVoteRequest\x1a\x1c.raft.v1.RequestVoteResponse\x12N\n" +
	"\rAppendEntries\x12\x1d.raft.v1.AppendEntriesRequest\x1a\x1e.raft.v1.AppendEntriesResponseBDZBgithub.com/geekofshire/dist-kv-store/internal/raftpb/raftv1;raftv1b\x06proto3"
...
var file_raft_v1_raft_proto_goTypes = []any{
	(CommandType)(0),              // 0: raft.v1.CommandType
...
var file_raft_v1_raft_proto_depIdxs = []int32{
	0, // 0: raft.v1.Entry.cmd:type_name -> raft.v1.CommandType
	3, // 1: raft.v1.AppendEntriesRequest.entries:type_name -> raft.v1.Entry
	1, // 2: raft.v1.RaftService.RequestVote:input_type -> raft.v1.RequestVoteRequest
	4, // 3: raft.v1.RaftService.AppendEntries:input_type -> raft.v1.AppendEntriesRequest
	2, // 4: raft.v1.RaftService.RequestVote:output_type -> raft.v1.RequestVoteResponse
	5, // 5: raft.v1.RaftService.AppendEntries:output_type -> raft.v1.AppendEntriesResponse
